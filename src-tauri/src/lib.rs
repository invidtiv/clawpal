...
use crate::commands::{
    ...
    local_openclaw_config_exists, log_app_event, manage_rescue_bot, open_url, preview_rollback,
    preview_session, read_app_log, read_error_log, read_gateway_error_log, read_gateway_log,
    read_raw_config, record_install_experience, refresh_discord_guild_channels,
