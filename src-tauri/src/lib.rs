...
use crate::commands::{
    ...
    remote_fix_issues, remote_get_cron_runs, remote_get_ssh_connection_profile,
    ...
    set_active_openclaw_home, set_agent_model, set_bug_report_settings,
    set_clawpal_logs_ui_preference, set_gateway_logs_ui_preference, set_global_model,
    set_openclaw_context_ui_preference, set_session_model_override,
